...
public class Thymio {
	...
	private final static long DRIVE_BIAS = 6000;
	...
	/**
	 * Setter for Thymio's speed Settings
	 * @param  type : Either "max" "rotation" or "ahead"
	 * @param  speed : speed value
	 */
	public void setSpeed(String type, int speed){
		switch (type) {
		case "max":
			MAX_SPEED = speed;
			break;
		case "rotation":
			SPEED_ROTATION = (short) speed;
			break;
			
		case "ahead":
			SPEED_AHEAD = (short) speed;
			break;
		default:
			break;
		}
	...
	public void drive(int motorLeft, int motorRight){
		...
		driveList.add((short) ((short) motorLeft));
